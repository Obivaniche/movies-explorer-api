...
const allowedCors = [
  'http://localhost:3000',
  'http://obivaniche-movies.nomoredomains.club',
  'https://obivaniche-movies.nomoredomains.club',
  'http://api.obivaniche-movies.nomoredomains.club',
  'https://api.obivaniche-movies.nomoredomains.club',
];
